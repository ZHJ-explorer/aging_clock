...
注：GSE123696、GSE123697、GSE123698、GSE164191 和 GSE213516 数据集的年龄范围信息在处理过程中自动提取，具体范围可参考各自的处理日志。

## 模型性能

| 方案                    | 交叉验证R²    | 测试集R²     | MAE        | RMSE       |
| --------------------- | --------- | --------- | ---------- | ---------- |
| **XGBoost单模型（350特征）** | **0.6021** | **0.5897** | **8.5312** | **10.8392** |
| Stacking（XGBoost + MLP）     | 0.6081    | 0.5646    | 8.7552     | 10.3431    |
